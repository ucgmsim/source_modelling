...
def test_loads_srcmod_fsp(fsp_path: Path):
    ...
    if fsp_file.fmax is not None and fsp_file.fmin is not None:
        assert 0 <= fsp_file.fmin <= fsp_file.fmax, (

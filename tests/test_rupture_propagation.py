    ...
    plane_a = sources.Plane.from_corners(
        np.array(
            [
                ...
                [-45.390362978215435, 170.27941127890773, 1000],
                [-45.0304811338428, 170.27941127890773, 1000],
            ]
        )
    )
    plane_b = sources.Plane.from_corners(
        np.array(
            [
                ...
                [-44.997796634347004, 170.42184906066956, 1000],
                [-44.86621465166093, 170.42184906066956, 1000],
            ]
        )
    )
    plane_c = sources.Plane.from_corners(
        np.array(
            [
                ...
                [-44.552027768554936, 170.52620234810502, 1000],
                [-44.552027768554936, 170.39890952912066, 1000],
            ]
        )
    )
    plane_d = sources.Plane.from_corners(
        np.array(
            [
                ...
                [-44.87057622488399, 170.9225453010559, 1000],
                [-44.77558750315725, 170.9225453010559, 1000],
            ]
        )
    )
